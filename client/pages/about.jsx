...
export default function About() {
  return (
    <div className='mx-auto mt-10 flex flex-col gap-3 items-center justify-center w-3/5'>
      <p className="comfortaa text-4xl font-bold text-[#676767] mb-16 about-text">
        About
      </p>
      <p className="comfortaa text-xl text-[#323232] leading-8 about-text">
      ...
      <p className="mt-10 comfortaa text-xl text-[#323232] leading-8 about-text">
